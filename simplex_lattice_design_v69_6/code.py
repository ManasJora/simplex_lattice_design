def simplex_lattice_design_v70_5():
    r"""
    # Overview
    ...
    # ==============================================================================
    # Internal imports to make the function self-contained
    import pandas as pd
    import numpy as np
    import itertools
    ...
    try:
        ...
        pass # Not running in Google Colab, or google.colab module not available

    # Try importing openpyxl, required for Excel export
    try:
        import openpyxl
    except ImportError:
        pass # Will be handled/warned if export is attempted without it
    ...
    def add_ingredient_row(b=None, initial_data=None):
        ...
        # INCREASED description_width for Max Active and Density to remove truncation
        ...
        w_max = widgets.BoundedFloatText(value=data['max'], min=0.0, max=100.0, step=1.0, description='Max Active (%):', 
                                         layout=widgets.Layout(width='170px'), style={'description_width': '110px'}) # Increased width
    ...
    def on_run(b):
        ...
        results_widgets = []
        results_widgets.append(widgets.HTML("<b style='color:black; font-size:16px;'>--- Running Simplex Lattice Design v70.5 ---</b>"))
        ...
        try:
            ...
            if w_csv.value and not df_valid.empty:
                fname = f'simplex_lattice_design_v70_5_{datetime.now().strftime("%H%M%S")}.xlsx'
    ...
    ui_content = [
        widgets.HTML("<div class='header-text'>🧪 Simplex Lattice Design v70.5</div>"),
